...
Welcome to the Expense Tracker Web Application! This simple web application helps you keep track of your monthly expenses and income conveniently. The application is built using MERN stack, and it utilizes the MongoDB Atlas storage to securely store your financial data.
